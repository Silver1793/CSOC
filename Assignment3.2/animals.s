...
//   return p;
	...
	msg8:
		.asciz "%s (yes/no) > "
	test1:
		.asciz "This is wbat you input %s"
	test2:
		.asciz "HERE!!!!!!!!"
...
// 	  else {
	...
	not_equal:
// 	    p->right = new_n;
// 	    p->left = new_node(p->question_or_animal); # GOTTA WORK ON THIS
// 	  }  # end of else
...
// 	  }  # end of else	
	...
	# Need label here
	response_cont:
	// 	  strcpy(p->question_or_animal, new_question_or_animal); # Work on this
